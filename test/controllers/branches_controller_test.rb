...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { name: @branch.name, promotion_id: @branch.promotion_id, vendor_id: @branch.vendor_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { name: @branch.name, promotion_id: @branch.promotion_id, vendor_id: @branch.vendor_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
