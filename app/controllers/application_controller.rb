class ApplicationController < ActionController::Base
 ...
 # skip_before_filter  :verify_authenticity_token
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:branches_to_be_added, :utype, :name, :email, :community, :nationality, :address, :number, :password, :password_confirmation, :community_id) }
